...
import com.qc.competition.db.entity.competition.CompetitionInstanceJson;
...
//    static public InputStreamReader getCompetitionInstanceJSONInputStreamReader(CompetitionInstanceJson competitionInstanceJson) {
//
//    }
//
//    static public CompetitionInstance getCompetitionInstanceJSON(CompetitionInstanceJson competitionInstanceJson) {
//        CompetitionInstance competitionInstance = null;
//        if (competitionInstanceJson != null && competitionInstanceJson.getJsonData() != null) {
//            InputStreamReader inputStreamReader = getCompetitionInstanceJSONInputStreamReader(competitionInstanceJson);
//            if (inputStreamReader != null) {
//                try {
//                    competitionInstance = fromReader(inputStreamReader, CompetitionInstance.class);
//                } catch (IOException e) {
//                    e.printStackTrace();
//                }
//            }
...
//    }
    ...
    public CompetitionInstanceJson updateCompetitionInstanceJSON(CompetitionInstanceJson competitionInstanceJson, JSONObject jsonObject) {
        competitionInstanceJson.setJsonData(ZipUtils.compress(objectToJSONString(jsonObject, false).getBytes()));
        competitionInstanceJson.setCompressed(true);
        competitionInstanceJson.setCompression(ZipUtils.COMPRESSION);
        return competitionInstanceJson;
