...
//                        Participant participant = competitionInstance.getParticipant(participantId);
    ...
    private static CompetitionComputationParam readCompetitionComputationParam(String propertiesFile) throws IOException {
        CompetitionComputationParam competitionComputationParam = CompetitionGeneratorConfiguration.getDefaultCompetitionComputationParamStatic(null, null, ParticipantType.TEAM_ONE_PARTICIPANT, 2, PlayVersusType.ONE_VS_ONE, 1,
