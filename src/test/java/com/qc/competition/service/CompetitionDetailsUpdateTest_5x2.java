 ...
 */
public class CompetitionDetailsUpdateTest_5x2 extends CompetitionDetailsUpdateTest {
    @Test
    @Override
    ...
    protected CompetitionComputationParam getCompetitionComputationParamBase() {
        ParticipantType participantType = ParticipantType.TEAM_TWO_PARTICIPANTS;
        PlayVersusType playVersusType = PlayVersusType.FREE_FOR_ALL_5_TEAMS_2_PARTICIPANTS;
        int numberOfParticipantMatch = playVersusType.numberOfTeam;
