...
public class CompetitionDetailsUpdateTest1v1_scoringmode_numberOfPlayRange extends CompetitionDetailsUpdateTest1v1 {
    @Override
    ...
    protected CompetitionComputationParam getCompetitionComputationParamBase() {
        ...
        ScoringConfigurationMatchElement scoringConfigurationMatchElement1 = new ScoringConfigurationMatchElement();
        scoringConfigurationMatchElement1.scoreScaleType = ScoreScaleType.ABSOLUTE_INTEGER_REVERSED;
        scoringConfigurationMatchElement1.participantScoreAggregateType = ParticipantScoreAggregateType.WIN;
        scoringConfigurationMatchElement1.priority = 1;

        ScoringConfigurationMatchElement scoringConfigurationMatchElement2 = new ScoringConfigurationMatchElement();
        scoringConfigurationMatchElement2.scoreScaleType = ScoreScaleType.ABSOLUTE_INTEGER_REVERSED;
        scoringConfigurationMatchElement2.participantScoreAggregateType = ParticipantScoreAggregateType.GOAL;
        scoringConfigurationMatchElement2.priority = 2;

        ScoringConfigurationMatchElement scoringConfigurationMatchElement3 = new ScoringConfigurationMatchElement();
        scoringConfigurationMatchElement3.scoreScaleType = ScoreScaleType.ABSOLUTE_INTEGER;
        scoringConfigurationMatchElement3.participantScoreAggregateType = ParticipantScoreAggregateType.GOAL_OPPONENTS;
        scoringConfigurationMatchElement3.priority = 3;
        ...
        competitionComputationParam.getMixingPhaseParameter().scoringConfiguration.scoringConfigurationMatch.scoringConfigurationMatchElements.add(scoringConfigurationMatchElement1);
        ...
        competitionComputationParam.getMixingPhaseParameter().scoringConfiguration.scoringConfigurationMatch.scoringConfigurationMatchElements.add(scoringConfigurationMatchElement3);
...
//        competitionComputationParam.getQualificationPhaseParameter().scoringConfiguration.scoringConfigurationMatch.rankingComputationPolicy = new RankingComputationPolicyScore();
        ...
        competitionComputationParam.getQualificationPhaseParameter().scoringConfiguration.scoringConfigurationMatch.scoringConfigurationMatchElements.add(scoringConfigurationMatchElement1);
        ...
        competitionComputationParam.getQualificationPhaseParameter().scoringConfiguration.scoringConfigurationMatch.scoringConfigurationMatchElements.add(scoringConfigurationMatchElement3);
        ...
        competitionComputationParam.getFinalPhaseParameter().numberOfPlayFinalMaximum = 5;
        ...
        competitionComputationParam.getFinalPhaseParameter().scoringConfiguration.scoringConfigurationMatch.scoringConfigurationMatchElements.add(scoringConfigurationMatchElement1);
        ...
        competitionComputationParam.getFinalPhaseParameter().scoringConfiguration.scoringConfigurationMatch.scoringConfigurationMatchElements.add(scoringConfigurationMatchElement3);
    ...
    public void createAndLaunchCompetition_16_6_SimpleElimination() {
        super.createAndLaunchCompetitionForSizeAndDuration(TestGenerationConfiguration.FinalPhaseSingleElimination, 16, 6, false);
    }


    public void createAndLaunchCompetition_3_1_AllMagic() {
        super.createAndLaunchCompetitionForSizeAndDuration(TestGenerationConfiguration.AllMagic, 3, 1, false);
    }


    public void createAndLaunchCompetition_16_3_AllMagic() {
        super.createAndLaunchCompetitionForSizeAndDuration(TestGenerationConfiguration.AllMagic, 16, 3, false);
    }
