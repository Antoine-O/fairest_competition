...
public class CompetitionDetailsUpdateTest1v1_with_laddering_then_round_robin_one_play_on_the_fly extends CompetitionDetailsUpdateTest1v1 {
    ...
    protected CompetitionComputationParam getCompetitionComputationParamBase() {
        ...
        competitionComputationParam.getFinalPhaseParameter().tournamentFormatsAccepted.add(TournamentFormat.ROUND_ROBIN);
