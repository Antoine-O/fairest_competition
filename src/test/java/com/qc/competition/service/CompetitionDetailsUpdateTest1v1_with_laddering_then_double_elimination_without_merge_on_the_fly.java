...
public class CompetitionDetailsUpdateTest1v1_with_laddering_then_double_elimination_without_merge_on_the_fly extends CompetitionDetailsUpdateTest1v1 {
...
//        competitionComputationParam.getQualificationPhaseParameter().phaseDuration = "PT1H";
        ...
        competitionComputationParam.getFinalPhaseParameter().mergePolicy = MergePolicy.NO_MERGE;
