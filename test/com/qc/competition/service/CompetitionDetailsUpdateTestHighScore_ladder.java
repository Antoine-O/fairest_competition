...
public class CompetitionDetailsUpdateTestHighScore_ladder extends CompetitionDetailsUpdateTest {
...
////                67 18
    ...
    @Test
    public void createAndLaunchCompetition_64() {
        int participantSize = 64;
        int durationInHour = 6;
////        59 16
////                59 18
////                59 23
////                67 18
    ...
    protected CompetitionComputationParam getCompetitionComputationParamBase() {
        ...
        competitionComputationParam.getMixingPhaseParameter().phaseDuration = Duration.ofMinutes(120).toString();
        ...
        competitionComputationParam.getQualificationPhaseParameter().phaseDuration = Duration.ofMinutes(120).toString();
        ...
        competitionComputationParam.getFinalPhaseParameter().phaseDuration = Duration.ofMinutes(120).toString();
