...
public class CompetitionDetailsUpdateTest1v1_with_laddering_then_double_elimination_one_play_on_the_fly extends CompetitionDetailsUpdateTest1v1 {
...
//        competitionComputationParam.getQualificationPhaseParameter().phaseDuration = "PT1H";
        ...
        competitionComputationParam.getFinalPhaseParameter().resetPolicy = ResetPolicy.NONE;
    ...
    public void createAndLaunchCompetition_18_6_save() {
        super.createAndLaunchCompetitionForSizeAndDuration(TestGenerationConfiguration.AllMagic, 18, 6, true);
    }
