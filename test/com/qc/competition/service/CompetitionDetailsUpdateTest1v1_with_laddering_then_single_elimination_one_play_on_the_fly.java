...
public class CompetitionDetailsUpdateTest1v1_with_laddering_then_single_elimination_one_play_on_the_fly extends CompetitionDetailsUpdateTest1v1 {
    ...
    protected CompetitionComputationParam getCompetitionComputationParamBase() {
        ...
        competitionComputationParam.getMixingPhaseParameter().registrationOnTheFly = true;
...
//        competitionComputationParam.getQualificationPhaseParameter().phaseDuration = "PT1H";
    ...
    public void createAndLaunchCompetitionForSizeAndDurationQuickSimple() {
        super.createAndLaunchCompetitionForSizeAndDurationQuickSimple();
    }
    ...
    public void createAndLaunchCompetition_8_6() {
        super.createAndLaunchCompetitionForSizeAndDuration(TestGenerationConfiguration.AllMagic, 8, 6, true);
    }
