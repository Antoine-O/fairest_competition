...
//                }
    ...
    public void test10TimesSameResultRound(int numberOfParticipant,
        ...
        int previousResult = CompetitionGroupFormat.ROUND_ROBIN.getNumberOfRounds(numberOfParticipant, numberOfParticipant, numberOfParticipantPerMatch, PlayVersusType.ONE_VS_ONE, numberOfParticipantQualifiedPerMatch, participantSplittable);
        int newResult = 0;
        for (int i = 0; i < 10; i++) {
            newResult = CompetitionGroupFormat.ROUND_ROBIN.getNumberOfRounds(numberOfParticipant, numberOfParticipant, numberOfParticipantPerMatch, PlayVersusType.ONE_VS_ONE, numberOfParticipantQualifiedPerMatch, participantSplittable);
